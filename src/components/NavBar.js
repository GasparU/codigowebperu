...
const NavBar = () => {
    ...
    return (
        <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lgpx-16 md:px-12 sm:px-8'>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                <nav>
                    ...
                    <CustomLink href={nosotros} title={"Nosotros"} className='mx-4' />
                    <CustomLink href={servicios} title={"Servicios"} className='ml-4' />
                ...
                isOpen ?
                    <motion.div
                        ...
                        <nav className='flex items-center justify-center flex-wrap mt-2'>
                            <p className='text-white dark:text-black'>Proyectos en Código</p>
            ...
            <div className='absolute left-[50%] top-2 transkate-x-[-50%]'>
                <Logo />
            </div>
        </header>
    )
